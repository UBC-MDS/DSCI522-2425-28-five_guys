...
![Distribution of Rented Bike Count](../results/figures/rented_bike_count.png){#fig-rented-bike-count}


![Average Rented Bike Count by Hour](../results/figures/hourly_rental_count.png){#fig-hourly-rental-count}


![Average Rented Bike Count by Season](../results/figures/season_rental_count.png){#fig-season-rental-count}


![Number of bike rentals at different temperatures for different seasons](../results/figures/season_temp_count.png){#fig-season-temp-count}


![Summary distribution of bike rentals between holidays and non holidays.](../results/figures/holiday_dist.png){#fig-holiday_dist}
...
![Distribution of number of rented bikes.](../results/figures/rented_bike_count.png){#fig-rented-bike-count}


![Mean number of bikes being rented at different time of the day.](../results/figures/season_hourly.png){#fig-season-hourly}
