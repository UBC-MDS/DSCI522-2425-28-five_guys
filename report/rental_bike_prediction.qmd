...
The chart in @fig-hourly-rental-count below shows the distribution of bike rentals across different hours of the day. It can be seen that there are two peak periods, signifying rush hour around 9 AM when people are going to work or school and there is a greater peak in the evening around 7 PM when most people return home after their daily engagements.
